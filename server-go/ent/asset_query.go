...
func (_q *AssetQuery) QueryTenant() *TenantQuery {
...
func (_q *AssetQuery) QueryVault() *VaultQuery {
...
func (_q *AssetQuery) WithTenant(opts ...func(*TenantQuery)) *AssetQuery {
	query := (&TenantClient{config: _q.config}).Query()
...
func (_q *AssetQuery) WithVault(opts ...func(*VaultQuery)) *AssetQuery {
	query := (&VaultClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *AssetQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Asset, error) {
	...
	if query := _q.withTenant; query != nil {
		if err := _q.loadTenant(ctx, query, nodes, nil,
			func(n *Asset, e *Tenant) { n.Edges.Tenant = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withVault; query != nil {
		if err := _q.loadVault(ctx, query, nodes, nil,
			func(n *Asset, e *Vault) { n.Edges.Vault = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *AssetQuery) loadTenant(ctx context.Context, query *TenantQuery, nodes []*Asset, init func(*Asset), assign func(*Asset, *Tenant)) error {
...
func (_q *AssetQuery) loadVault(ctx context.Context, query *VaultQuery, nodes []*Asset, init func(*Asset), assign func(*Asset, *Vault)) error {
	ids := make([]string, 0, len(nodes))
	nodeids := make(map[string][]*Asset)
	for i := range nodes {
		fk := nodes[i].VaultID
...
func (_q *AssetQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withVault != nil {
			_spec.Node.AddColumnOnce(asset.FieldVaultID)
		}
	}
