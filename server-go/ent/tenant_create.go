...
func (_c *TenantCreate) AddVaultIDs(ids ...string) *TenantCreate {
	_c.mutation.AddVaultIDs(ids...)
	return _c
}

// AddVaults adds the "vaults" edges to the Vault entity.
func (_c *TenantCreate) AddVaults(v ...*Vault) *TenantCreate {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *TenantCreate) AddAssetIDs(ids ...string) *TenantCreate {
